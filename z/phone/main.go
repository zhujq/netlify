...
func handleRequest(ctx context.Context, request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	phonenum := request.QueryStringParameters["phonenum"]
	if phonenum == "" {
		return events.APIGatewayProxyResponse{Body: "欢迎使用中国电话号码查询系统，请在网址后输入 /?phonenum=电话号码 查询!", StatusCode: 200}, nil
	} else {
		var message ResBody
		...
		if err != nil {
			...
			return events.APIGatewayProxyResponse{Body: "查询不到你输入的中国号码信息!", StatusCode: 200}, nil
		}
